...
Note: BSR is updated by pricing_sync (if implemented). This job syncs
rating and review_count from the Catalog Items API into product_snapshots.
"""
...
from sync.spapi.catalog import get_catalog_item
    ...
    try:
        ...
        for product in products:
            try:
                ...
                logger.warning("reviews_sync_item_failed", asin=product["asin"], exc=str(exc))
